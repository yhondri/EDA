...
void testCompareSet1() {
    SetOfInts1 setOfInst1 = SetOfInts1();
    SetOfInts1 setOfInst2 = SetOfInts1();
    
    int newValue;
    cin >> newValue;
    setOfInst1.add(newValue);
    cin >> newValue;
    setOfInst2.add(newValue);
    
    if (setOfInst1 == setOfInst2) {
...
void testLessThanSet3() {
    SetOfInts3 setOfInst1 = SetOfInts3();
    SetOfInts3 setOfInst2 = SetOfInts3();
    
    int size = 5;
    
    int newValue;
    cout << "Introduce al menos 5 valores" << endl;
    while (size > 0) {
        cin >> newValue;
        setOfInst1.add(newValue);
        size--;
    ...
    cout << "Introduce máximo 5 valores" << endl;
    size = 5;
    while (size > 0) {
        cin >> newValue;
        setOfInst2.add(newValue);
    ...
    if (setOfInst1 < setOfInst2) {
        cout << "S1 es subconjunto de S2" << endl;
    }else {
        cout << "S1 no es subconjunto de S2" << endl;
    }
